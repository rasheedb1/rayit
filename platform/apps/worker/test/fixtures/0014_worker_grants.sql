-- =====================================================================
-- 0014 · Privilegios del rol mc_worker  (PROPUESTA de CON-2, ver
--        docs/propuestas/CON-2.md; la aplica Rasheed en db/migrations/)
-- ---------------------------------------------------------------------
-- mc_worker existe desde 0010 con NOLOGIN y BYPASSRLS, pero sin ningún
-- privilegio sobre las tablas: hoy no puede ni leer job_definition. El
...
-- OPTION sobre mc_worker, que solo tiene postgres): eso va por
-- scripts/supabase-admin.sh, fuera de db/migrations/.
--
-- En pruebas se aplica sobre pglite después de las 13 migraciones,
-- exactamente como quedaría en Supabase.
-- =====================================================================
