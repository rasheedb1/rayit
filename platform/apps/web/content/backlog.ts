...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "hecho",
    note: "En /finanzas/ingresos: importar CSV (AdSense mensual o diario, Creator Rewards y una lista genérica), agregar a mano, lista por mes y el estimado mensual; y en /finanzas/flujo, la columna «Otros ingresos» con su barra y su nota. La idempotencia es de la base: el UNIQUE natural de la migración 0036, PENDIENTE de aplicar en Supabase; hasta entonces el import falla en producción con 42P10. El promedio vive en packages/core/src/ingresos-plataformas.ts y entra a projectCashflow (FIN-6) por otrosIngresosMensual, que es opcional: sin estimado, el flujo se comporta igual que antes. Se reutilizan finanzas.flujo.ver y finanzas.pago.registrar en vez de crear finanzas.ingreso.*: el catálogo viaja en la semilla de 0034 y accesos.test.ts exige que sea idéntica (docs/propuestas/FIN-7.md §1.2). Propuesta: docs/propuestas/FIN-7.md.",
  },
  {
