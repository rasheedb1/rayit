...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "hecho",
    note: "/finanzas es ahora la pantalla de cobro (listReceivables sobre la vista receivables, ordenada por urgencia en SQL, con Segmented por aging_bucket y buscador en la URL) y el archivo completo de facturas se mudó a /finanzas/facturas, con pestañas entre las dos. Solo lectura: nada de ACC-2, pero ACC-1 entró antes que la historia y las dos pantallas abren con requirePermission(\"finanzas.factura.ver\") como primera línea. Sin migración. Los esqueletos pasaron a los grupos (inicio) y facturas/(lista) porque en la raíz del segmento envolvían también el detalle de una factura (pulido r4). Pendiente de tu visto bueno en docs/propuestas/FIN-3.md §0.2: si las sumas de getReceivablesKpis deben viajar como null en un workspace sin facturas (hoy son «0» y la pantalla lo dice con una frase).",
  },
  {
