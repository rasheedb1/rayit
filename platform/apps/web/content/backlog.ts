...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "bloqueada",
    note: "23-sep: código y pruebas con respuestas grabadas en la rama nicolas/CON-7-demografia-audiencia, solo local. Bloqueada por la prueba en vivo: ninguna fuente por @ da demografía y hace falta una conexión autorizada con permisos de insights. Su migración 0036 choca con la 0036 de FIN-7: una de las dos tiene que renumerarse antes de fusionar.",
  },
  {
  ...
  // ---------------------------------------------------------------- FIN
  {
    ...
    status: "hecho",
    note: "Hecha el 21-sep (PR #2), en producción. Lista con KPIs, formulario con total en vivo, detalle con Marcar enviada y Anular, y facturarCampana() para «Facturar» de CAM-1; sobre @mc/db y lib/workspace desde CIM-2 y CIM-3 (22-sep). lib/forms.ts la adopta FIN-2. Propuesta: docs/propuestas/FIN-1.md.",
  },
  {
  ...
  },
  {
    ...
    status: "en_curso",
    note: "23-sep: terminada en la rama nicolas/FIN-3-cuentas-por-cobrar (en GitHub, sin fusionar; también va en nicolas/FIN-integracion). /finanzas pasa a ser la pantalla de cobro por antigüedad y el archivo de facturas se muda a /finanzas/facturas. Sin migración. Pendiente de visto bueno: docs/propuestas/FIN-3.md §0.2.",
  },
  {
  ...
  },
  {
    ...
    status: "en_curso",
    note: "23-sep: rama nicolas/FIN-5-gastos, solo local, con cambios sin commitear: /finanzas/gastos, formulario y proyección a ocho semanas. Sin migración. El recibo es un enlace, no un archivo. Falta cambiar sus TODO(ACC-1) y TODO(ACC-2) por requirePermission y audit(), que ya están en main.",
  },
  {
