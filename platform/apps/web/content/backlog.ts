...
export const STORIES: readonly Story[] = [
  ...
  // ---------------------------------------------------------------- RES
  {
    ...
    status: "hecho",
    note: "Pantalla real sobre datos reales, con toda la aritmética en SQL (queries/resumen.ts): KPIs con delta y sparkline, dos gráficos del kit con su tabla, frescura por conexión y estado vacío en vez de ceros. Decisión que importa: el reloj es el último día cerrado de las dos fuentes y las barras cubren exactamente el periodo (detalle en docs/fases-rasheed.md §8).",
  },
  {
