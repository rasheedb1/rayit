...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "hecho",
    note: "23-sep: evidencia v2 (onBehalfOf + actedBy, IP resumida) en los dos caminos (por @ y OAuth), aviso connection_added al titular (migración 0038, pendiente de aplicar), onBehalfOf/actedBy en cada fila de audit() de conexiones y «Conectada por … el …» en /conexiones. El permiso se comprueba además dentro de la transacción leyendo role_permission (requirePermission resuelve Dueño hasta ACC-5). El mánager con la casilla de ACC-4 se prueba con un rol a medida del workspace. Propuesta en docs/propuestas/ACC-8.md.",
  },
  {
