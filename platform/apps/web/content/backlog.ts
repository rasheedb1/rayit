...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "bloqueada",
    note: "23-sep: construida y probada contra respuestas grabadas en la rama nicolas/CON-7-demografia-audiencia (worker 69, db 705, la lógica de prerrequisitos en 2 s). Bloqueada por la prueba en vivo: ninguna fuente pública da demografía —business_discovery no la trae, YouTube la da por Analytics con OAuth y TikTok por la Accounts API con el trámite CON-9— y hoy no hay ninguna conexión autorizada con permisos de insights. El job escribe audience_breakdown con scope 'account' y, cuando falta un prerrequisito, NO llama a la API: escribe el requisito en metric_gap (migración 0038) con el message_es de metric_requirement, que es lo que lee RES-4 por getAccountAudience. 0038 añade además el UNIQUE que le faltaba a audience_breakdown y siete filas de metric_requirement, entre ellas el requisito nuevo owner_authorization para las cuentas agregadas por @. Era 0036, pero ese número lo reclama también FIN-7: se renumeró a 0038, el primero libre por encima de la 0037 de CAM-6. Detalle en docs/propuestas/CON-7.md."
  },
  {
