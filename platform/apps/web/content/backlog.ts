...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "hecho",
    note: "En /finanzas/ingresos: importar CSV (AdSense mensual o diario, Creator Rewards y una lista genérica), agregar a mano, lista por mes y el estimado mensual; y en /finanzas/flujo, la columna «Otros ingresos» con su barra y su nota. La idempotencia es de la base: el UNIQUE natural de la migración 0036, aplicada en Supabase; en producción desde el 23-sep (7737b62). La puerta de ACC-5 en sus tres páginas (404 sin permiso) entra con P0. El promedio vive en packages/core/src/ingresos-plataformas.ts y entra a projectCashflow (FIN-6) por otrosIngresosMensual, que es opcional: sin estimado, el flujo se comporta igual que antes. Se reutilizan finanzas.flujo.ver y finanzas.pago.registrar en vez de crear finanzas.ingreso.*: el catálogo viaja en la semilla de 0034 y accesos.test.ts exige que sea idéntica (docs/propuestas/FIN-7.md §1.2). Propuesta: docs/propuestas/FIN-7.md.",
  },
  {
