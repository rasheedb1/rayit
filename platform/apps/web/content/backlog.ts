...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "hecho",
    note:
      "Hecha el 22 de septiembre (ronda 3). Enlace mágico con Supabase Auth, todo en el servidor; quién eres sale del correo verificado, la cookie mc.workspace solo elige entre tus espacios, y sin sesión no se sirve ningún espacio (falla cerrado aunque el middleware no mire). Pendiente del integrador: 0022 y 0023 (sesión y membership) sin aplicar en Supabase; endurecer-db y COT-1 también traen una 0022, así que las de CIM-3 se renumeran detrás de esas antes de aplicar nada. A mano, una vez, en el panel de Supabase: Redirect URLs con /**, plantilla con token_hash y Confirm email (apps/web/README.md#autenticación). Fuera: invitar a otras personas, cambiar de correo y Google.",
  },
  {
