...
export const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    status: "hecho",
    note: "Seed 0002 determinista e idempotente cualquier día, y que no caduca: 60 videos con curvas ancladas a la primera corrida, la serie de la cuenta que se extiende hasta ayer al volver a sembrar, demografía, línea base por día de cálculo y puntaje con la regla de scoring.ts, y el CRM con 8 marcas, 12 señales y 15 deals (10 abiertos · COP 95,5 M · ponderado 43,15 M). Volver a sembrar refresca lo que la demo mira hoy —cierre esperado y próxima acción de los deals abiertos, señales pendientes, ventana del brief, frescura de las conexiones— y congela lo que ya pasó. Las cuatro campañas llevan su deal, así que la cadena señal → deal → campaña → factura se recorre entera. Verificación en Postgres embebido: cifras, prueba de la baja en outbound_touch, tercera pasada con el reloj a +1, cuarta que resiembra la misma base a +41 y siembra en limpio a +40 días (node db/seed/verify/run.mjs [--dias 40], también en CI). Toca 0003 (Nicolás) lo mínimo: línea de tiempo de Café Alma y las dos lecturas de Fresko condicionadas a su fecha (CIM-6.md §3.10). Decisiones en docs/propuestas/CIM-6.md.",
  },
  {
