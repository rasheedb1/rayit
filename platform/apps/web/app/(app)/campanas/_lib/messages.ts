 ...
 * concreta: «Lo que aportó la marca» (CAM-4), «Resultado» (CAM-5),
 * «Seguidores de la marca» (CAM-3) y el reporte a la marca (CAM-6: su
 * sección, su documento, su página pública y las frases que enviar deja
 * en otras tablas). Las pantallas
