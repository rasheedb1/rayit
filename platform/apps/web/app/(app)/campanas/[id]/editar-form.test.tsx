...
describe("SeguimientoForm", () => {
  it("cerrado muestra solo el botón; abierto envía solo código y enlace y se cierra al guardar", async () => {
    ...
    render(<SeguimientoForm campaignId={CAMPANA} trackingCode="LAURA15" trackingUrl={null} />);
  ...
  it("los errores del servidor se pintan en español con aria-invalid y el foco va al primero", async () => {
    ...
    render(<SeguimientoForm campaignId={CAMPANA} trackingCode={null} trackingUrl={null} />);
...
describe("DatosForm", () => {
  it("un mensaje general (campaña cerrada) se anuncia arriba y el formulario sigue abierto", async () => {
    ...
    render(<DatosForm campaignId={CAMPANA} name="Lanzamiento cold brew" startsOn="2026-08-24" endsOn="2026-08-31" brief={null} />);
