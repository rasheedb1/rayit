...
/**
 * El escenario del `--demo` del worker, con el añadido que CON-4 tiene
 * que enseñar: un token que YA venció sin que nadie lo haya anotado.
      ...
      `INSERT INTO social_connection
       ...
       VALUES
         ...
         (current_workspace_id(), $1, 'tiktok', 'tt-demo-3', 'cafealma.tienda', 'Café Alma · Tienda',
          'creator', $3, '{user.info.basic,video.list}', now() - interval '2 hours', now() + interval '300 days',
          'direct_oauth', 'active', now() - interval '30 hours', now() - interval '40 days'),
