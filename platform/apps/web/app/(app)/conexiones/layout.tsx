...
/**
 * La puerta del módulo (ACC-5). Corre en todas las rutas de /conexiones:
 * sin conexiones.cuenta.ver —o con la bandera apagada— la ruta responde 404,
 ...
 */
export default async function ConexionesLayout({ children }: { children: ReactNode }) {
