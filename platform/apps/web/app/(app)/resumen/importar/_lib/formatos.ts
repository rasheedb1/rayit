...
const ALIAS: Record<Campo, readonly string[]> = {
  ...
  publishedAt: [
    ...
    "publicado el", "fecha de publicacion del video",
  ],
  title: ["description", "descripcion", "video title", "titulo del video", "title", "titulo", "caption", "texto de la publicacion", "post text", "nombre del video", "texto"],
  ...
  reach: [
    "accounts reached", "cuentas alcanzadas", "personas alcanzadas", "reach", "alcance", "accounts center accounts reached",
    "unique viewers", "espectadores unicos",
  ],
