...
export default async function CuentasPorCobrarPage({
  ...
  const { kpis, receivables, recordatorios } = await withWorkspace(async (tx) => ({
    ...
    // ha marcado como enviado. El filtro de la tabla no la toca: es el
    // trabajo de cobro de hoy, y vive en la pantalla de cobro.
