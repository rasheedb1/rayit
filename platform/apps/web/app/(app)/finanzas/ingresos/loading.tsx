...
/**
 * Esqueleto del segmento mientras la base responde: los mismos tres
 * KPI, la tarjeta del flujo de caja y una tabla de seis filas, del
 * mismo tamaño que la pantalla real, para que una consulta lenta no
 * deje la navegación congelada sin señal.
 */
  ...
  return (
    <div aria-busy="true" aria-label={t.label}>
      ...
      <section className="mt-10">
        ...
        <div className="h-24 animate-pulse rounded-md border border-border bg-hover" />
      </section>
      <section className="mt-10">
