...
describe("el permiso finanzas.flujo.ver manda (ACC-1, ACC-5)", () => {
  it("el rol Mánager no abre la pantalla: 404 (ACC-5), y NI SIQUIERA se lee la base", async () => {
    ...
    // 404 y no 403 ni la frontera de error: no se confirma que la pantalla existe.
