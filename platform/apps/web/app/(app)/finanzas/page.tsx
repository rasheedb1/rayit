      ...
      <PageHeader
        ...
        aside={
          <div className="flex flex-wrap gap-2">
            {/* Gastos (FIN-5) vive en su propia pantalla: comparten el módulo y la moneda, no la tabla. */}
            <Button href="/finanzas/gastos" variant="secondary">
              {MESSAGES.gastos.header.desdeFinanzas}
            </Button>
