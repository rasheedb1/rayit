...
describe('pulido, ronda 4: mc_public_share tiene exactamente lo que promete 0030', () => {
  ...
  test('el inventario declarado es el de 0030, 0031, 0033 y 0037, y la base recién migrada lo cumple', async () => {
    ...
    assert.equal(Object.keys(POLITICAS_DEL_ENLACE_PUBLICO).length, 10, 'las siete de 0030, la aceptada del negocio de 0033 y las dos del reporte de 0037');
