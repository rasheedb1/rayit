...
export { assertScopeAllows, assertUnscoped, SCOPE_KINDS, ScopeError, scopeFilter, UNSCOPED_ONLY, type ScopeAnchors, type ScopeKind, type ScopeMany } from './scope.ts';
export {
