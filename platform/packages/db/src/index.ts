...
export {
  ...
  explicarEsquema, migracionesDelRepositorio, PRIVILEGIOS, PRIVILEGIOS_DE_LA_APP,
  type EstadoDelEsquema, type Privilegio, type PrivilegioDeMas, type TablaSinAislar,
} from './esquema.ts';
