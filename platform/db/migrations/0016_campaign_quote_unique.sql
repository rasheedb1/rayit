-- =====================================================================
-- 0016 · Una campaña por cotización (CAM-2)
-- (Nació como 0015 en la rama de CAM-2; se renumeró al integrarla porque
-- 0015_connection_secret.sql, de CON-3, ya estaba aplicada en Supabase.)
-- ---------------------------------------------------------------------
