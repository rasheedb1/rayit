...
| 4 | Migración 0016 (`campaign_quote_unique`, antes 0015) pendiente en Supabase. | Media para CAM-2, nula para la web | `make db.migrate` (Nicolás). |
...
|---|---|---|
| COT-4 (Rasheed, sprint 4) | `createCampaignFromQuote()` con contrato escrito | Listo: firma, errores, garantías y guion de prueba conjunta en `CAM-2.md`. Falta aplicar 0016. |
...
la migración 0016 para COT-4, y es un comando de Nicolás.
