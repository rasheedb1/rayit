...
**Actualizado el 21 de septiembre de 2026 a las 20:30** con el cierre
de las historias de Nicolás del sprint 1: las cinco están en `main`,
verificadas dos veces y desplegadas en producción. El detalle, la
doble verificación y lo que Rasheed tiene que destrabar están en la
...
https://multicampaign-web.vercel.app sirve `main` con FIN-1 dentro.
